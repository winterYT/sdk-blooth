...
typedef NS_ENUM(NSUInteger, OHQDataType) {
    ...
    OHQDataTypeDeviceId,                    /**< Device Id (Type of Data : NSString) */
    OHQDataTypeDeviceCategory,               /**< Device Category (Type of Data : NSNumber(OHQDeviceCategory)) */
    OHQDataTypeBeaconIdentifier,             /**< Beacon Identifier (Type of Data : NSDictionary<OHQBeaconIdentifierDataKey,id>) */
...
/** Device Id (Type of value : NSUUID) */
extern OHQDeviceInfoKey const OHQDeviceInfoDeviceIdKey;
...
/** Allow Access to Beacon Identifier (Type of value : NSNumber[BOOL])
 
 A Boolean value that specifies whether reading beacon identifier.
 It works only on devices that support the Omron Extension protocol.
 The value for this key is an NSNumber object. If the key is not specified, the default value is NO.
 */
extern OHQSessionOptionKey const OHQSessionOptionAllowAccessToBeaconIdentifierKey;
...
typedef NSString * OHQBeaconIdentifierDataKey NS_STRING_ENUM;
/** Proximity UUID (Type of value : NSUUID) */
extern OHQBeaconIdentifierDataKey const OHQBeaconIdentifierDataProximityUUIDKey;
/** Major (Type of value : NSNumber) */
extern OHQBeaconIdentifierDataKey const OHQBeaconIdentifierDataMajorKey;
/** Minor (Type of value : NSNumber) */
extern OHQBeaconIdentifierDataKey const OHQBeaconIdentifierDataMinorKey;
