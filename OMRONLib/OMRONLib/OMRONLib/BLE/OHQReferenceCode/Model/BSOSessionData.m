...
@property (readwrite, nullable, copy, nonatomic) NSString *deviceId;
...
@property (readwrite, nullable, copy, nonatomic) NSDictionary<OHQBeaconIdentifierDataKey,id> *beaconIdentifier;
...
- (void)addSessionData:(id)data withType:(OHQDataType)type {
    switch (type) {
        ...
        case OHQDataTypeBeaconIdentifier: {
            self.beaconIdentifier = data;
            break;
        }
