...
@property (readonly, nullable, copy, nonatomic) NSString *deviceId;
...
@property (readonly, nullable, copy, nonatomic) NSDictionary<OHQBeaconIdentifierDataKey,id> *beaconIdentifier;
