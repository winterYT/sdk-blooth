...
NSString * OHQDataTypeDescription(OHQDataType value) {
    ...
    switch (value) {
        ...
        case OHQDataTypeDeviceId:                    ret = @"Device Id";                         break;
        case OHQDataTypeDeviceCategory:               ret = @"Device Category";                  break;
        case OHQDataTypeBeaconIdentifier:             ret = @"Beacon Identifier";                break;
...
OHQDeviceInfoKey const OHQDeviceInfoDeviceIdKey = @"deviceId";
...
OHQSessionOptionKey const OHQSessionOptionAllowAccessToBeaconIdentifierKey = @"optAllowAccessToBeaconIdentifier";
...
// Beacon Identifier Data Key
OHQBeaconIdentifierDataKey const OHQBeaconIdentifierDataProximityUUIDKey = @"proximityUUID";
OHQBeaconIdentifierDataKey const OHQBeaconIdentifierDataMajorKey = @"major";
OHQBeaconIdentifierDataKey const OHQBeaconIdentifierDataMinorKey = @"minor";
